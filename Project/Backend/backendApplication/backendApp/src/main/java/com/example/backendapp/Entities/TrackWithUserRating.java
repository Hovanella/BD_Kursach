...
@NamedStoredProcedureQueries(@NamedStoredProcedureQuery(name = "GET_TRACKS_FOR_USER", procedureName = "GET_TRACKS_FOR_USER", resultClasses = TrackWithUserRating.class, parameters = {
